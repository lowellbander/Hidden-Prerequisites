...
\bibitem{1} Statistical Models Applied to the Rating of Sports Teams, \textbf{Kenneth Massey} 
\bibitem{2} Sync-Rank: Robust Ranking, Constrained Ranking And Rank Aggregation Via Eigenvector And Sdp Synchronization, \textbf{Mihai Cucuringu}
